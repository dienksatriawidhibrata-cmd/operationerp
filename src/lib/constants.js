...
export const BRANCH_SHIFTS = {
  'Bagi Kopi - Bintaro':         [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('CLOSING','15:00 - 23:00')],
  'Bagi Kopi - Buah Batu':       [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Cawang':          [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Cilandak Barat':  [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('CLOSING','15:00 - 23:00')],
  'Bagi Kopi - Ciledug':         [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  ...
  'Bagi Kopi - Ciputat Jombang': [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Ciputat Juanda':  [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  ...
  'Bagi Kopi - Jatinangor':      [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Kalimalang':      [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Karawaci':        [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Kayu Putih':      [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','12:00 - 20:00'), S('MIDDLE 1 WEEKEND','11:00 - 19:00'), S('MIDDLE 2 WEEKEND','15:00 - 23:00'), S('CLOSING','16:00 - 24:00'), S('CLOSING WEEKEND','19:00 - 03:00')],
  'Bagi Kopi - Kemang Utara':    [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  ...
  'Bagi Kopi - Lebak Bulus':     [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  ...
  'Bagi Kopi - Margonda Raya':   [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('OPENING 2','09:30 - 18:00'), S('MIDDLE 1','12:00 - 20:00'), S('CLOSING','16:00 - 00:00')],
  ...
  'Bagi Kopi - Pamulang':        [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Pekayon':         [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Pengumben':       [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Peta':            [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
  'Bagi Kopi - Setu Cipayung':   [S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00')],
...
export const DEFAULT_SHIFTS = [
  S('DAY OFF'), S('OPENING','06:30 - 15:00'), S('MIDDLE 1','11:00 - 19:00'), S('MIDDLE 2','15:00 - 23:00'), S('CLOSING','19:00 - 03:00'),
]
