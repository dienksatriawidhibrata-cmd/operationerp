  ...
  return (
    <div className="space-y-2">
      ...
      {!disabled && value.length < max && (
        capture === false ? (
          <div className={`flex gap-2 ${uploading ? 'pointer-events-none opacity-60' : ''}`}>
            <button
              type="button"
              onClick={() => inputRef.current?.click()}
              disabled={uploading}
              className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border-2 border-dashed border-primary-300 bg-white py-2.5 text-sm font-medium text-primary-600 hover:bg-primary-50 active:scale-98"
            >
              {uploading ? (
            ...
            <button
              ...
              disabled={uploading}
              className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border-2 border-dashed border-slate-300 bg-white py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-50 active:scale-98"
            >
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
